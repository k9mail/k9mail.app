...
<img src="../../assets/img/docs/accounts_list.png" alt="Accounts List" width="300" />
...
* Tapping the folder icon shows the full list of [folders](/docs/folders)
...
* Account settings - This provides a link to the accounts [settings page](/docs/settings/account)
